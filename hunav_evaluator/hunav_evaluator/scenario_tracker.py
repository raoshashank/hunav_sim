...
class HunavEvaluatorNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('algorithm', 'random')
        ...
        self.result_file_path = f'/home/shashank/code/my_packages/sonas_ws/src/scenario_generation/hunav_sim/hunav_evaluator/results/metrics_{self.scenario}_{self.algorithm}.txt'
        ...
        self.goal_sub = self.create_subscription(PoseStamped, 'dummy_goal_pose', self.goal_callback, 1)
        self.stop_recording_sub = self.create_subscription(PoseStamped,'finished_navigation',self.stop_recording_callback,1)
    ...
    def store_metrics(self, result_file):
        ...
        file.write(self.scenario)
        file.write('\t')
        
        file.write(self.algorithm)
        file.write('\t')
